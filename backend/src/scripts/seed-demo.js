...
const usersSeed = [
  {
    key: "admin",
    name: "CareGo Admin",
    email: process.env.ADMIN_EMAIL || "admin@carego.test",
    phone: "0900000000",
    role: "admin",
  },
{
...
},
{
  ...
  email: "customer.van@carego.test",
  phone: "0910000000",
  role: "customer",
},
{
...
},
{
  key: "companionB",
  name: "Phạm Gia Huy",
  email: "companion2@carego.test",
  phone: "0904444444",
  role: "companion",
},
{
  key: "companionPending",
  name: "Đỗ Mai Linh",
  email: "companion.pending@carego.test",
  phone: "0905555555",
  role: "companion",
},
{
  key: "companionKhoi",
  name: "Phạm Anh Khôi",
  email: "companion.khoi@carego.test",
  phone: "0906666666",
  role: "companion",
},
{
  ...
  email: "companion.thanh@carego.test",
  phone: "0907777777",
  role: "companion",
},
{
  key: "companionTuan",
  name: "Phạm Minh Tuấn",
  email: "companion.tuan@carego.test",
  phone: "0908888888",
  role: "companion",
},
{
  ...
  email: "companion.hoangthanh@carego.test",
  phone: "0909999999",
  role: "companion",
},
];
...
const companionProfilesSeed = [
  {
    ...
    major: "Điều dưỡng",
    skills: ["Chăm sóc tại nhà", "Nhắc thuốc", "Hỗ trợ đi khám"],
    documents: {
  ...
  },
  {
    ...
    major: "Y khoa",
    skills: ["Theo dõi GPS", "Sơ cứu cơ bản", "Đồng hành đi dạo"],
    documents: {
      citizenId: "079202000002",
      citizenIdFrontUrl: "",
      citizenIdBackUrl: "",
      studentCardUrl: "",
      backgroundCheckUrl: "",
    ...
    vettingStatus: "approved",
    serviceAreas: ["Quận 7", "Quận 4"],
    ratingAverage: 4.6,
    ratingCount: 8,
    completedBookings: 10,
  },
  {
    userKey: "companionPending",
    fullName: "Đỗ Mai Linh",
    phone: "0905555555",
    gender: "female",
    dateOfBirth: new Date("2004-02-21"),
    university: "Đại học Văn Lang",
    major: "Tâm lý học",
    skills: ["Trò chuyện", "Đọc sách", "Chăm sóc tinh thần"],
    documents: {
      citizenId: "079204000003",
      citizenIdFrontUrl: "",
      citizenIdBackUrl: "",
      studentCardUrl: "",
      backgroundCheckUrl: "",
