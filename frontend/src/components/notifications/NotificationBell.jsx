...
const typeStyles = {
  ...
  BOOKING_INCIDENT_REPORTED: "bg-rose-50 text-rose-700",
  BOOKING_INCIDENT_RESOLVED: "bg-amber-50 text-amber-700",
  COMPANION_CHECKED_IN: "bg-indigo-50 text-indigo-700",
  COMPANION_BOOKING_REASSIGNED: "bg-cyan-50 text-cyan-700",
